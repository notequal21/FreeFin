        ...
        <Card>
          <CardContent className='pt-6'>
            <p className='text-center text-muted-foreground'>
              У вас пока нет категорий. Создайте первую категорию, чтобы начать
              работу.
            </p>
          </CardContent>
        </Card>
          ...
          {privateCategories.length > 0 && (
            <Card className='mb-4'>
              <CardHeader>
                ...
                <CardDescription>
                  Ваши приватные категории, которые можно редактировать и
                  удалять
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          {commonCategories.length > 0 && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Общие категории, доступные всем пользователям. Их нельзя
